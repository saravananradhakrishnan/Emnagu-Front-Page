...
class ApplicantsControllerTest < ActionController::TestCase
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post :create, applicant: { contact: @applicant.contact, email: @applicant.email, name: @applicant.name, resume: @applicant.resume }
    end
  ...
  test "should update applicant" do
    patch :update, id: @applicant, applicant: { contact: @applicant.contact, email: @applicant.email, name: @applicant.name, resume: @applicant.resume }
    assert_redirected_to applicant_path(assigns(:applicant))
  end
